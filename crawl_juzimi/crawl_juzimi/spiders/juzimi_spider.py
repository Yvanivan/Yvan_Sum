...
class JuzimiSpiderSpider(scrapy.Spider):
    ...
    name = "juzimi_spider"
    start_urls = ['http://www.juzimi.com/ju/1016']
                  # 'http://www.juzimi.com/ju/3', 796(177)
                  # 'http://www.juzimi.com/ju/4',
                  # 'http://www.juzimi.com/ju/5',
                  # 'http://www.juzimi.com/ju/6']

    def parse(self, response):

        # res = response.xpath("//title/text()").extract()[0]

        #res = response.xpath("//div[@id='bdshare']/@data").extract()[0]
